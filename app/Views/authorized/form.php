<div class="col-auto" style="width: 440px">
    <div class="card card-body">
        <form action="<?= base_url('authorized/save') ?>" method="post" class="row g-3 form-floating needs-validation"
            novalidate>
            <!-- timezone-->
            ...
            <!-- hidden input -->
            <input name="authorized_id" type="hidden" value=<?= isset($edit_enabled) ? $item['authorized_id'] : ''; ?>>
            <!-- submit -->
