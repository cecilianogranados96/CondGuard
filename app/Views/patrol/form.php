    ...
    <div class="card card-body">
        ...
        <form action="<?= base_url('patrol/save') ?>" method="post" class="row g-3 form-floating needs-validation"
            ...
            <div class="form-floating">
                <input class="form-control only-number" type="text" id="latitude" name="latitude" placeholder="Latitud"
                    data-bs-toggle="tooltip" data-bs-placement="right" title="Latitud válida ej: 40.000."
                    value="<?= isset($item) ? $item['latitude'] : ''; ?>" required
                    pattern="([-+]?(([1-8]?\d(\.\d+))+|90))" />
            ...
            <div class="form-floating">
                <input class="form-control only-number" type="text" id="longitude" name="longitude"
                    ...
                    title="Longitud válida ej: 40.000." value="<?= isset($item) ? $item['longitude'] : ''; ?>" required
                    pattern="([-+]?(([1-8]?\d(\.\d+))+|90))" />
            ...
            <div class="form-floating">
                <input class="form-control" type="text" id="code" name="code" placeholder="Código QR"
                    data-bs-toggle="tooltip" data-bs-placement="right" title="Código QR."
