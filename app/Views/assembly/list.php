<div class="container-fluid my-2" style="
    ...
    <div class="col">
        <div class="card card-body">
            <a href="<?php echo base_url('assembly/new') ?>" class="btn btn-primary" data-bs-toggle="tooltip"
                title="Nuevo" role="button" style="font-size: 30px; margin-bottom: 10px;">Nueva asamblea <i
