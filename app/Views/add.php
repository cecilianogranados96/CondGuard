    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <form method="post" name="frmAddStudent" id="frmAddStudent"
                    action="<?php echo site_url('student/store'); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image" class="form-control" id="image"
                            onchange="previewImageFile(this);" accept=".png, .jpg, .jpeg" />
